...
export const metadata: Metadata = {
  title: "Coffee Haven - Specialty Coffee & Espresso",
  description: "Discover premium specialty coffee crafted by expert baristas. Fresh beans, artisan brewing, and the perfect cup every time.",
  keywords: "specialty coffee, espresso, cappuccino, cold brew, barista, coffee shop",
  metadataBase: new URL("https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765796965510-3zkp665o.jpg"),
  alternates: {
    canonical: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765796965510-3zkp665o.jpg"
  },
  robots: {
    index: true,
    follow: true
  ...
  openGraph: {
    title: "Coffee Haven - Your Specialty Coffee Destination",
    description: "Experience exceptional specialty coffee crafted with precision and passion",
    siteName: "Coffee Haven",
    type: "website",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765796965510-3zkp665o.jpg",
  ...
  twitter: {
    ...
    title: "Coffee Haven - Specialty Coffee",
    description: "Premium espresso and specialty beverages",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34my1kGeblbsCcwUUCcjBY9WFkg/uploaded-1765796965510-3zkp665o.jpg"]
  }
};
